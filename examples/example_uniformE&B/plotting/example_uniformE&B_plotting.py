"""
example_uniformE&B_plotting.py

Combined loader + plotting for the uniform E + uniform B example.

It:
1. Loads example_uniformE_B_results.npz from the ../results directory.
2. Generates:
   - Temperature history
   - Energy distribution
...
def main() -> None:
    ...
    # examples/
    #   example_uniformE_B/
    #       example_uniformE&B_main.py
    #       results/
    #           example_uniformE_B_results.npz
    #       plotting/
    #           example_uniformE&B_plotting.py  <-- this file
    ...
    results_path = results_dir / "example_uniformE_B_results.npz"

    if not results_path.is_file():
        msg = (
            f"Could not find results file at: {results_path}\n"
            "Make sure you've run example_uniformE&B_main.py first."
        )
