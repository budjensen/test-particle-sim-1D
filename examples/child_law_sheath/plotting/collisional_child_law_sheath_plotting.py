...
def plot_trajectory(time_s, trajectories, save_path=None):
    ...
    plt.title("Tracer Particle Trajectories: Collisional Child Law Sheath")
    plt.xlabel("Time (s)")
...
def plot_energy_distribution(energy_eV, pdf, save_path=None):
    ...
    plt.title("Surface IEDF: Collisional Child Law Sheath")
...
def main():
    ...
    plot_energy_distribution(
        ...
        / "plotting/collisional_child_sheath_energy_distribution.png",
    )
    plot_trajectory(
        time,
        tracer_traj,
        save_path=Path(__file__).parent.parent
        / "plotting/collisional_child_sheath_tracer_trajectories.png",
    )
